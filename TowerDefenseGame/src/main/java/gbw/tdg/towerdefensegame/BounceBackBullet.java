...
public class BounceBackBullet extends Bullet {
    ...
    public BounceBackBullet(Point2D position, Enemy target, ITower owner, BounceReciever<Enemy,Bullet> reciever) {
        super(position, target, owner);
        this.reciever = reciever;
    }

    public BounceBackBullet(Point2D position, Point2D velocity, ITower owner, BounceReciever<Enemy,Bullet> reciever) {
